...
const AddAddress = ({ openAddress = false, onClose }) => {
  ...
  const getPinCode = async (pincode) => {
    ...
    try {
      ...
      const {data} = response;
     setUserAddress({...userAddress, district: data[0].PostOffice[0].District, postoffice: data[0].PostOffice[0].BranchType,
...
/>
            ...
            >
              <Button variant="contained" onClick={()=>handleSaveAddress(userAddress)}>Save</Button>
            </Box>
          </Box>
        </Fade>
      </Modal>
